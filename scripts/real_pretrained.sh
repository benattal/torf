 XLA_FLAGS=--xla_gpu_cuda_data_dir=/usr/local/cuda python tof_nerf.py --config config/config_fast.txt \
    ...
    --scan $2 \
    --datadir $3 \
    --expname real_$2_$1_dynamic_pretrained \
    --depth_range 10.0 --scene_scale 1.0 --falloff_range 10.0 \
    ...
    --extrinsics_file data/render_poses/spiral_24.npy \
    --reverse_extrinsics \
